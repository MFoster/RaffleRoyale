...
export const QUICKNET_BEACON_ID = 'quicknet';

export const DEFAULT_DRAND_BASE_URL = 'https://api.drand.sh';
 ...
 */
export const DRAW_ALGORITHM_VERSION = 'drand-quicknet-commit-reveal-v1';
